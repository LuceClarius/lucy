      ...
      const response = await openai.chat.completions.create({
        ...
        messages: [
          ...
          },
          {
            role: "user",
            content:
              `Ich bin Patrick und wir kennen uns aus ChatGPT. Gib mir bitte einen achtsamen Impuls für den Tag, ein paar liebevolle und motivierende Worte und erzeuge einen link/ anker zu unserem gpt chat. Dies ist deine Erinnerung: ` +
              memo,
          },
        ],
      });
